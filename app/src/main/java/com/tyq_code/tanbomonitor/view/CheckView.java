package com.tyq_code.tanbomonitor.view;
...
public class CheckView extends View {
    ...
    private       int time  = 0;
    private int mScreenWidth  = Constant.mScreenWidth;
    private int mScreenHeight = Constant.mScreenHeight;
